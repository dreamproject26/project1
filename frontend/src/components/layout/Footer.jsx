      ...
      <div className="relative container-executive py-20">
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 space-y-3 text-sm text-primary-foreground/80">
              <p className="flex items-start gap-3"><Mail className="h-4 w-4 text-accent mt-0.5" /> {siteSettings.email}</p>
              <p className="flex items-start gap-3"><Phone className="h-4 w-4 text-accent mt-0.5" /> {siteSettings.phone}</p>
              <p className="flex items-start gap-3"><MapPin className="h-4 w-4 text-accent mt-0.5" /> {siteSettings.address}</p>
            </div>
          </div>
        ...
        <div className="mt-16 pt-6 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-primary-foreground/60">
            ...
            <span className="flex items-center gap-2"><span className="pulse-dot" /> {siteSettings.business_hours}</span>
          </div>
        </div>
      </div>
    </footer>
