...
import { founder, journey, ventures } from '@/data/mockData';
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 bg-primary text-primary-foreground overflow-hidden">
        ...
        <div className="relative container-executive grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-6 font-display font-semibold text-4xl sm:text-5xl lg:text-[68px] leading-[1.05] text-primary-foreground">
              {founder.full_name}
            </h1>
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-[4/5] rounded-sm overflow-hidden border border-accent/30">
              <img src={founder.photo_url} alt={founder.full_name} className="w-full h-full object-cover" />
        ...
        <div className="container-executive">
          ...
          <div className="mt-14 grid md:grid-cols-3 gap-6">
            {journey.slice(-6).map((j) => (
              <div key={j.year} className="p-6 border border-white/10 bg-primary-foreground/[0.03] rounded-sm">
